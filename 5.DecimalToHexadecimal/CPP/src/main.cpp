...
#include "../include/DecimalToHexadecimal.hpp"
#include "../include/DecimalToHexadecimalTest.hpp"
#include <fstream>
#include <iostream>
#include <vector>
#include <string>
...
int main() {
    Util util;
    DecimalToHexadecimalTester tester;  // Change to DecimalToHexadecimalTester
